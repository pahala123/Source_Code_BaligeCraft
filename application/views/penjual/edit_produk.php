                ...
                <section class="section">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-12">
                            <div class="card">
                                <form method="post" class="needs-validation" action="<?php echo base_url('penjual/edit/' . $produk->produk_id); ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 col-12">
                                                ...
                                                <input type="file" name="produk_gambar" id="produk_gambar" class="form-control" value="<?php echo $produk->produk_gambar; ?>">
                                            </div>
                                            <div class="form-group col-md-6 col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 col-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="produk_berat" id="produk_berat" class="form-control currency" value="<?php echo $produk->produk_berat; ?>">
                                                ...
                                                <div class="controls">
                                                    <select name="produk_kategori" class="form-control">
                                                        ...
                                                        <?php foreach ($kategori as $kategori) { ?>
                                                            <option value="<?php echo $kategori->id ?>" <?php if ($produk->produk_kategori == $kategori->id) {
                                                                                                            echo "selected";
                                                                                                        } ?>>
                                    ...
                                    <div class="card-footer text-right">
                                        <button type="submit" class="btn btn-primary" style="border-color: #e99c2e;" onclick="return confirm('Yakin ingin mengubah Produk?');">Simpan</button>
