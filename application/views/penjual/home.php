							...
							<ul>
								...
								<li class="nav-item submenu dropdown">
									...
									<ul class="dropdown-menu menu">
										...
										<li class="nav-item"><a class="nav-link" href="penjual/logout"><span class="lnr lnr-exit"> Logout</span></a></li>
									</ul>
								</li>
							</ul>
	...
	<?php if (@$_SESSION['login-penjual']) { ?>
		<script>
			swal({
				title: "Selamat Datang <?= $penjual['nama'] ?>",
				text: "Anda Berhasil Login Sebagai Penjual",
				icon: "success",
				button: "ok"
			});
		</script>
		<!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
	<?php unset($_SESSION['login-penjual']);
	} ?>