...
class Order_model extends CI_Model
{
    ...
    public function get_all_orders($limit, $start)
    {
        ...
        $orders = $this->db->query("
            SELECT o.id, o.order_number, o.order_date, o.order_status, o.pesanan_status , o.payment_method, o.total_price, o.total_items, u.username AS user
            FROM orders o
            JOIN user u
                ON u.id = o.user_id
            WHERE o.user_id = '$id'
    ...
    {
        $data = $this->db->query("
            SELECT o.*, p.payment_price, p.payment_date, p.picture_name, p.payment_status, p.confirmed_date, p.payment_data, r.nomor
            FROM orders o
    ...
    {
        $items = $this->db->query("
            SELECT oi.produk_id, oi.order_qty, oi.order_price, p.produk_nama, p.produk_gambar
            FROM order_item oi
            JOIN produk p
	            ON p.produk_id = oi.produk_id
            WHERE order_id = '$id'");
    ...
    public function set_statusresi($data)
    {
